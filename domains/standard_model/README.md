...
## Contents
- **[`STANDARD_MODEL_CLOSURE.md`](STANDARD_MODEL_CLOSURE.md)** — the honest closure LEDGER: what closes (Th_coqc/finite-blind) vs the 3 open bottlenecks. Read this first for any SM claim.
